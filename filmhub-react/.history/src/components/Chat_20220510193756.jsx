  ...
  <div className="chat-container">
    <div className="chat">
    {
      messages.map((message) => 
        ...
        <div><img src={message.photoURL} alt='user'/> {message.displayName}</div>
    ...
    <MyButton style={{color: 'black', border: '2px solid black'}} onClick={() => sendMessage()}>send message</MyButton>
  </div>
  );
};
